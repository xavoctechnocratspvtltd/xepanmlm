...
class page_xMLM_page_owner_xmlm_credits_approved extends page_xMLM_page_owner_main {
	
	function page_index(){
		$credit_model = $this->add('xMLM/Model_Credit_Approved');
		...
		$crud->add('xHR/Controller_Acl'/*,array('override'=>array('can_view'=>'All','allow'))*/);
	}
}