...
class page_xMLM_page_owner_xmlm_downlineview extends page_xMLM_page_owner_xmlm_main{
	function init(){
		...
		$left_grid->setModel('xMLM/Distributor',array('username','name','sponsor','introducer','left','right','created_at','greened_on'))
		...
		$right_grid->setModel('xMLM/Distributor',array('username','name','sponsor','introducer','left','right','created_at','greened_on'))
